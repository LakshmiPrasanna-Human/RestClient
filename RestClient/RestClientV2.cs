...
{
    public class RestClientV2<T, R> where T : class where R : class
    {
        ...
        public RestClientV2(string baseAddress, string accessToken)
        {
        ...
        public async Task<R> PostRequestMultipleType(HttpClient client, string apiUrl, T postObject)
        {
            R result = null;
        ...
        public async Task<R> PutRequestMultipleType(HttpClient client, string apiUrl, T putObject)
        {
            R result = null;
            if (client.BaseAddress == null)
            {
